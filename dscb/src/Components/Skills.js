export default function Skills(props){
    return(
        <div className="skill-bg [font-family:'Poppins'] md:w-full h-auto md:h-[35.9375rem] flex flex-col items-center justify-center pt-10 py-10 md:py-0 md:pt-0">
           ...
           <div className="w-full md:w-[50rem] md:text-lg md:font-[400] mt-3 md:px-10 text-center tracking-[0.03938rem] leading-6 md:mt-5">These listings are listed based on our testing datasets, there are cases which will be covered soon!</div>
