export default function Skills(props){
    return(
        <div className="[background:#FF006B] [font-family:'Poppins'] md:w-full h-auto md:h-[35.9375rem] flex flex-col items-center justify-center pt-10 py-10 md:py-0 md:pt-0">
           ...
           <div className="md:w-[50rem] md:text-lg md:font-[400] px-10 text-center tracking-[0.03938rem] leading-6 md:mt-5">Lorem ipsum dolor sit amet consectetur. Imperdiet convallis blandit felis ligula aliquam venenatis fghh hgjj nisi ante.</div>
          <div className="w-full grid grid-cols-1 md:grid-cols-4 gap-12 mt-12 px-5 md:px-0">
            {
