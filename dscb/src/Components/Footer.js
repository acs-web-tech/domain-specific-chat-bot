...
export default function Footer(props){
    return(
        <div className="[font-family:'Poppins'] flex flex-col relative justify-center items-center md:h-[30.5rem] md:gap-16 pt-5 md:pt-0 pb-10 md:pb-0 ">
            ...
            <div className="w-full text-black self-end bg-white absolute bottom-0 text-center md:text-[1.3125rem] md:font-[400] tracking-[0.03938rem]">Powered By 4DUCATE</div>
        </div>
    )
}